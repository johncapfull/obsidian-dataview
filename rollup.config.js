...
const DEV_PLUGIN_CONFIG = {
    ...BASE_CONFIG,
    output: {
        dir: "test-vault/.obsidian/plugins/dataview-dev",
        sourcemap: "inline",
        format: "cjs",
        exports: "default",
    ...
    plugins: getRollupPlugins(
        ...
        copy({
            targets: [
                { src: "manifest.json", dest: "test-vault/.obsidian/plugins/dataview-dev/" },
                { src: "styles.css", dest: "test-vault/.obsidian/plugins/dataview-dev/" },
            ],
        })
    ),
};
